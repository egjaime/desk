...
?>
			...
			<body class="hold-transition skin-blue sidebar-mini">
				...
				<section class="content-header">
				  <h1>
					Descargar Gestión Transvial
				  </h1>
				  <ol class="breadcrumb">
					<li><a href="../menu.php"><i class="fa fa-dashboard"></i> Principal</a></li>
					<li><a>Usuario</a></li>
					<li class="active">Gestión Transvial</li>
				  </ol>
				</section>
									...
									<div class="box-body">
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div class="form-group" id="us3">
													...
													<select id="refresh"  onchange="pro_estado();" class="form-control select2" style="width: 100%;">
													  ...
													  <!--<option value="9">Toda la base..</option>-->
     												</select>
     												<div id="id2-2"></div>
												</div>
											...
											<div class="row">
												<div class="col-md-12">
													<div class="col-md-12">
														<ediv class="box-tools" id="MsjError0" align="center">
															<!–mensaje de error–> 
														</div>
												</div>
												</div>
				  ...
				  $(function () {
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           $("#carga").load('0_SUPERVISORES/Descargas/exp_val_exp_gestionECDF.php?a1='+camp1.value+'&a2='+camp2.value);

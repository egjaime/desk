            ...
            <tbody>
				...
				?>
					<tr>
						...
						<td><button type="button"  id="<?php echo $rows['codigo_bd']. '$' . $rows['cedula']. '$' .$rows['nombre']. '$' .$rows['nm_citacion']  ?>" onClick="pro_pendientes22(this.id);" class="btn btn-info pull-center">Modificar</button></td>
					</tr>
				<?php
					} 
				?>

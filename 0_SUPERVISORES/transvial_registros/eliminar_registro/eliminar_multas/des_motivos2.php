...
?>
			...
			<body class="hold-transition skin-blue sidebar-mini">
				...
				<section class="content-header">
				  <h1>
					Buscar caso a eliminar - Transvial
				  </h1>
				</section>
											...
											<div class="col-md-6">
												    ...
												    <div id="us2" class="form-group">
    													...
    													<i class="fa fa-edit"></i>
    													  ...
    													  <input type="text" class="form-control"  onKeyPress="return validar_texto(event)" id="valuebusqueda" data-mask tabindex="2" maxlength="15">
    													</div>
    													<div id="id2-2M"></div>
    												</div>
                        ...
                        if(document.getElementById("valuebusqueda").value === ""){
    					   ...
    					   $('#id2-2M').hide().html('<span class="help-block"><i class="fa fa-bell-o"></i> Indique el valor a buscar</span>').fadeIn(500);
        				    ...
        				    if(document.getElementById("mot_pr").value === "1"){
        				        ...
        				        $("#cargaX").load('0_SUPERVISORES/transvial_registros/eliminar_registro/eliminar_multas/exp_val_exp_gestionSA.php?a1='+b+'&a2='+ document.getElementById("mot_pr").value);

...
?>
			...
			<body class="hold-transition skin-blue sidebar-mini">
				...
				<section class="content-header">
				  <h1>
					Casos gestionados por asesor - Transvial
				  </h1>
				  <ol class="breadcrumb">
					<li><a href="../menu.php"><i class="fa fa-dashboard"></i> Principal</a></li>
					<li><a>Supervisor</a></li>
					<li class="active">Gestión Asesores transvial</li>
				  </ol>
				</section>
											...
											<div class="col-md-6">
												<div class="form-group" id="us2">
													...
													<option value="-1">Todos los usuarios</option>
													    <?php
															$trx9="SELECT * FROM usuarios WHERE servicio LIKE '%3%' AND rol='3' ORDER BY usuario ASC";  
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           if(camp2.value === "5"){
                               ...
                               $("#carga").load('0_SUPERVISORES/Asesores/exp_val_exp_gestionSA.php?a1=1&a2='+camp1.value+'&a4='+b);
                           }else{
                               $("#carga").load('0_SUPERVISORES/Asesores/exp_val_exp_gestionSA.php?a1=2&a2='+camp1.value+'&a3='+camp2.value);
                           }

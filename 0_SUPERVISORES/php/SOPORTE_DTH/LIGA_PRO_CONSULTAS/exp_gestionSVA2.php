...
?>
			...
			<body class="hold-transition skin-blue sidebar-mini">
				...
				<section class="content-header">
				  <h1>
					Consultas SuperCopa Ecuador
				  </h1>
				  <ol class="breadcrumb">
					<li><a href="../menu.php"><i class="fa fa-dashboard"></i> Principal</a></li>
					<li><a>Usuario</a></li>
					<li class="active">Gestión SuperCopa</li>
				  </ol>
				</section>
				  ...
				  $(function () {
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           $("#carga").load('0_SUPERVISORES/php/SOPORTE_DTH/LIGA_PRO_CONSULTAS/exp_val_exp_gestionSA32.php?a1='+camp1.value+'&a2='+camp2.value);

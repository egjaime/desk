...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <link rel="stylesheet"
    ...
    <div class="modal-body"> 
      <table id="example293345197" class="table table-bordered table-striped">
        <thead>
            <tr>
            ...
            <tbody>
				<?php
				    ...
				    if($a1==="-1"){
				      $block = mysqli_query($enlace, "SELECT *,CONCAT(u.1er_nombre,' ', u.1er_apellido) As Nombre FROM tmp_ppv e INNER JOIN usuarios u ON u.id=e.id_usuario WHERE e.fecha BETWEEN '$fch1' AND '$fch2'");
				    }else{
				      $block = mysqli_query($enlace, "SELECT *,CONCAT(u.1er_nombre,' ', u.1er_apellido) As Nombre FROM tmp_ppv e INNER JOIN usuarios u ON u.id=e.id_usuario WHERE e.id_usuario='$a1' AND e.fecha BETWEEN '$fch1' AND '$fch2'"); 
				    }
...
<script>
     ...
     function descargar_excel2(){
       ...
       self.location = "0_SUPERVISORES/php/SOPORTE_DTH/LIGA_PRO_CONSULTAS/exp_dowload_excelSVA2.php?a19="+a1+"&a22="+a2+"&a33="+a3;
    }
   
  $(function () {
    $('#example293345197').DataTable( {
        "destroy": true,
        "pageLength": 10,
        "searching": false,
        "lengthChange": false,
        ...
        language: {
            "decimal":        "",
            "emptyTable":     "No se encontraron consultas por SuperCopa",

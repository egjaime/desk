				  ...
				  $(function () {
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           $("#carga").load('0_SUPERVISORES/php/SOPORTE_DTH/DTH/exp_val_exp_gestionSA3.php?a1='+camp1.value+'&a2='+camp2.value);

...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <link rel="stylesheet"
    ...
    <div class="modal-body"> 
      <table id="example29334519" class="table table-bordered table-striped">
        <thead>
            <tr>
              	<th>Fecha</th>
        		<th>N-Virtual</th>
            ...
            <tbody>
				<?php
				    if($a1==="-1"){
				      $block = mysqli_query($enlace, "SELECT * FROM tmp_ppv2 WHERE fecha BETWEEN '$fch1' AND '$fch2'");
				    }else{
				        $block = mysqli_query($enlace, "SELECT * FROM tmp_ppv2 WHERE id_usuario='$a1' AND fecha BETWEEN '$fch1' AND '$fch2'"); 
				    }
...
<script>
     ...
     function descargar_excel2(){
       ...
       self.location = "0_SUPERVISORES/php/SOPORTE_DTH/DTH/exp_dowload_excelSVA.php?a19="+a1+"&a22="+a2+"&a33="+a3;
    }
   
  $(function () {
    $('#example29334519').DataTable( {
        "destroy": true,
        "pageLength": 10,
        "searching": false,
        "lengthChange": false,
        language: {
            "decimal":        "",
            "emptyTable":     "No se encontraron Casos no atendidos",

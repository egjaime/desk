...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <link rel="stylesheet"
    ...
    <div class="modal-body"> 
      <table id="example29334518" class="table table-bordered table-striped">
        <thead>
            <tr>
              	<th>Fecha</th>
        		<th>N-Virtual</th>
...
<script>
     ...
     function descargar_excel2(){
       ...
       self.location = "0_SUPERVISORES/php/SOPORTE_DTH/FINAL_LIGA_PRO/exp_dowload_excelSVA.php?a19="+a1+"&a22="+a2+"&a33="+a3;
    }
   
  $(function () {
    $('#example29334518').DataTable( {
        "destroy": true,
        "pageLength": 10,
        "searching": false,
        "lengthChange": false,

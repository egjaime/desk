...
?>
			...
			<body class="hold-transition skin-blue sidebar-mini">
				...
				<section class="content-header">
				  <h1>
					Información de Retenciones - LIGA PRO
				  </h1>
				  <ol class="breadcrumb">
					<li><a href="../menu.php"><i class="fa fa-dashboard"></i> Principal</a></li>
					<li><a>Usuario</a></li>
					<li class="active">Gestión LIGA PRO</li>
				  </ol>
				</section>
											...
											<div class="col-md-6">
												<div class="form-group" id="us2">
													...
													<option value="-1">Todos los asesores</option>
													    <?php
															$trx9="SELECT id, usuario FROM usuarios WHERE `servicio` like '%1%' ORDER BY `usuario` ASC";  
				  ...
				  $(function () {
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           $("#carga").load('0_SUPERVISORES/php/SOPORTE_DTH/LIGA_PRO_RETENCIONES/exp_val_exp_gestionSA32.php?a1='+camp1.value+'&a2='+camp2.value);

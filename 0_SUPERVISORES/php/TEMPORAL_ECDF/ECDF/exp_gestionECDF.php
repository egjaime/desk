...
?>
			...
			<body class="hold-transition skin-blue sidebar-mini">
				...
				<section class="content-header">
				  <h1>
					Campaña Ventas El Canal del Fútbol
				  </h1>
				  <ol class="breadcrumb">
					<li><a href="../menu.php"><i class="fa fa-dashboard"></i> Principal</a></li>
					<li><a>Usuario</a></li>
					<li class="active">Ventas ECDF</li>
				  </ol>
				</section>
				  ...
				  $(function () {
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           $("#carga").load('0_SUPERVISORES/php/TEMPORAL_ECDF/ECDF/exp_val_exp_gestionECDF.php?a1='+camp1.value+'&a2='+camp2.value);

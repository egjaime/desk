				  ...
				  $(function () {
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           $("#carga").load('0_SUPERVISORES/php/RETENCIONES/CARTERIZADOS/exp_val_exp_gestionSA32.php?a1='+camp1.value+'&a2='+camp2.value);

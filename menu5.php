<?php
  ...
  if($_SESSION['servicio'] == "5" || $_SESSION['servicio'] == "1,2,3,4,5" || $_SESSION['servicio'] == "1,5" || $_SESSION['servicio'] == "1,3,5" || $_SESSION['servicio'] == "0,1,2,3,4,5,6,7,8" || $_SESSION['servicio'] == "5,6"){//valido si pertenece a esta campaña
            ...
            <ul class="dropdown-menu">
              <li class="header">Duplicidad GPON</li>
               <li>
                <ul class="menu">
                  <li>
                    <a href="8_ESPECIFICAS_INT/cobranzas tmp/INFORMACIÓN DUPLICADIAD GPON.pdf" target="_blank">
                      <div class="pull-left">
                        <img src="assets/img/cnt_logo.png" class="img-circle" alt="User Image">
                      </div>
                      <h4>
    ...
    <section class="sidebar">
      ...
      <!-- /.search form -->
		...
		<li class="header">ENTRANTES</li>
			<li>
			  <a href="5_ESPECIFICAS/documentos/GESTION_ENTRANTE.pdf" target="_blank">
				<i class="fa fa-share-square-o"></i> <span>Gestión Entrante</span>
				<span class="pull-right-container">
        ...
        <li class="header">CALIDAD</li>
            ...
            <li class="treeview">
    			  ...
    			  <ul class="treeview-menu">
    			      ...
    			      <li><a href="5_ESPECIFICAS/documentos/06 JUNIO 2021 MALLA UNIFICADA DE BENEFICIOS RETENCION.xlsx" ><i class="fa fa-circle-o"></i> Malla de Junio</a></li>

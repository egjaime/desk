...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <link rel="stylesheet"
    ...
    <div class="modal-body"> 
      <table id="example293345" class="table table-bordered table-striped">
        <thead>
            <tr>
				<th>Banco</th>
				<th>Num. Cuenta</th>
            ...
            <tbody>
				<?php
				    $block = mysqli_query($enlace, "SELECT * FROM rechazos_dth WHERE servicio=$a1"); 
...
<script>
  ...
  $(function () {
    $('#example293345').DataTable( {
        ...
        language: {
            "decimal":        "",
            "emptyTable":     "No se encontro el Numero de Servicio",

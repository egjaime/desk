											...
											<div class="col-md-6">
												<div class="form-group" id="us2">
													...
													<option value="-1">Todos los usuarios</option>
													    <?php
															$trx9="SELECT id, usuario FROM usuarios WHERE rol='3' ORDER BY usuario id";  
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           if(camp2.value === "5"){
                               ...
                               $("#carga").load('php/supervision/exp_val_exp_gestionGE.php?a1=1&a2='+camp1.value+'&a4='+b);
                           }else{
                               $("#carga").load('php/supervision/exp_val_exp_gestionGE.php?a1=2&a2='+camp1.value+'&a3='+camp2.value);
                           }

...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <link rel="stylesheet"
    ...
    <div class="modal-body"> 
      <table id="example29334519399" class="table table-bordered table-striped">
        <thead>
            <tr>
            ...
            <tbody>
				<?php
				    if($a1==="-1"){
				      $block = mysqli_query($enlace, "SELECT * FROM HBOFidelizacion WHERE fecha_atencion BETWEEN '$fch1' AND '$fch2' AND cod_venta != 9 AND cod_venta != 0");
				    }else{
				        $block = mysqli_query($enlace, "SELECT * FROM HBOFidelizacion WHERE cod_vendedor='$a1' AND fecha_atencion BETWEEN '$fch1' AND '$fch2'  AND cod_venta != 9 AND cod_venta != 0"); 
				    }
...
<script>
     ...
     function descargar_excel2(){
       ...
       self.location = "3_fidelizacion_HBO/Descargas/exp_dowload_excelECDF.php?a19="+a1+"&a22="+a2+"&a33="+a3;
    }
   
  $(function () {
    $('#example29334519399').DataTable( {
        "destroy": true,
        "pageLength": 20,
        "searching": false,
        "lengthChange": false,

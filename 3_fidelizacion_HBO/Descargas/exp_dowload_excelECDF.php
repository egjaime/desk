...
<?php
	...
	if($a3==="-1"){
	   ...
	   $block = mysqli_query($enlace, "SELECT *,CONCAT(u.1er_nombre,' ', u.1er_apellido) As nombre_as, TIMESTAMPDIFF(DAY,`fecha_citacion`,NOW()) as dias_mora FROM HBOFidelizacion e INNER JOIN usuarios u ON u.id=e.cod_vendedor WHERE cod_vendedor='$a3' AND e.fecha_atencion BETWEEN '$a1' AND '$a2' AND cod_venta != 9 AND cod_venta != 0"); 
	} 
...
?>
  <tr style="text-align:left; height:30px;">
    ...
    <td style="width:110px; text-align:center;"><?php echo $res[21]; ?></td>
    ...
    <td style="width:110px; text-align:center;"><?php echo $res[19]; ?></td>

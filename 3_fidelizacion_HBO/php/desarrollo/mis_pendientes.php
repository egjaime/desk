...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <link rel="stylesheet"
    ...
    <div class="box-header">
      <h3 class="box-title">Todos los casos agendados</h3>
    </div>
    <div class="modal-body"> 
      <table id="exampleN97" class="table table-bordered table-striped">
        <thead>
            ...
            <tbody>
				<?php
					$block = mysqli_query($enlace, "SELECT `codigo_bd`,`cedula`,`nombre`,`placa`,`fecha_agendamiento`,`hora_agendamiento`,`cant_contactos`, `observacion`, `motivo_tip2`, `asignado_fecha` FROM HBOFidelizacion WHERE `cod_venta`=5 AND `cod_vendedor`='{$_SESSION['id']}'");
...
<script>
  ...
  function pro_pendientes22(id){
      ...
      if (confirm("\xbfContinuar y gestionar?")){
         ...
         $("#content1").load('3_fidelizacion_HBO/php/desarrollo/gestion_pendientes.php', {aa1: ced, aa2: name, aa3: cod_bd});
      }
  }
  ...
  $(function () {
    $('#exampleN97').DataTable( {
        ...
        language: {
            "decimal":        "",
            "emptyTable":     "No hay multas agendadas",

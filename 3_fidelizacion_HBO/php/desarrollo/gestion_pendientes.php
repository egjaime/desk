                ...
                function anadir_caso(){
			        ...
			        if(band_anadir1 == 1 && band_anadir2 == 1 && band_anadir3 == 1 && band_anadir4 == 1 && band_anadir5 == 1){
			             if (confirm("\xbfAñadir multa?")){
    			             ...
    			             $.ajax({
        					     type: 'POST',
        					     url: '3_fidelizacion_HBO/php/verPendientes/anadir_multa_new.php', 
        					     data:  dataStringA, 
        					     success: function(x){
        					         $('#MsjError2').hide().html('<div class="alert alert-success alert-dismissible"><button type="button" class="close" onclick="closeError()"  aria-hidden="true">&times;</button><strong>Agregado!</strong> Multa Añadida..<a href="#" class="alert-link"></a>.</div>').fadeIn(500);

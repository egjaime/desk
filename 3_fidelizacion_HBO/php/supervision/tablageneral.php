...
?>
			...
			<body class="hold-transition skin-blue sidebar-mini">
				...
				<section class="content-header">
				  <h1>
					Detalles de Ventas HBO - IMPULSA
				  </h1>
				  <ol class="breadcrumb">
					<li><a href="../menu.php"><i class="fa fa-dashboard"></i> Principal</a></li>
					<li><a>Supervisor</a></li>
					<li class="active">Ventas HBO</li>
				  </ol>
				</section>
											...
											<div class="col-md-6">
												<div class="form-group" id="us2">
													...
													<option value="-1">Todos los usuarios</option>
													    <?php
															$trx9="SELECT id, usuario FROM usuarios WHERE rol='3' AND servicio='3'  ORDER BY usuario ASC";  
				  ...
				  $(function () {
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           if(camp2.value === "5"){
                               var b = camp3.value.replace(/ /g, "");
                               $("#carga").load('3_fidelizacion_HBO/php/supervision/exp_val_exp_gestionHBO.php?a1=1&a2='+camp1.value+'&a4='+b);
                           }else{
                               $("#carga").load('3_fidelizacion_HBO/php/supervision/exp_val_exp_gestionHBO.php?a1=2&a2='+camp1.value+'&a3='+camp2.value);
                           }

...
?>
			...
			<body class="hold-transition skin-blue sidebar-mini">
				...
				<section class="content-header">
				  <h1>
					Descargar Denuncias 1800LoJusto
				  </h1>
				  <ol class="breadcrumb">
											...
											<div class="col-md-6">
												<div class="form-group" id="us2">
													...
													<option value="-1">Todos los usuarios</option>
													    <?php
															$trx9="SELECT id, usuario FROM usuarios WHERE rol='3' AND servicio='1,2' OR servicio='2' ORDER BY usuario ASC";  
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           if(camp2.value === "5"){
                               ...
                               $("#carga").load('2_1800lojusto/php/exp_val_exp_gestionGE.php?a1=1&a2='+camp1.value+'&a4='+b);
                           }else{
                               $("#carga").load('2_1800lojusto/php/exp_val_exp_gestionGE.php?a1=2&a2='+camp1.value+'&a3='+camp2.value);
                           }

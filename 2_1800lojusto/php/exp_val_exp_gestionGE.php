...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <link rel="stylesheet"
    ...
    <div class="modal-body"> 
      <table id="example098" class="table table-bordered table-striped">
        <thead>
            <tr>
                <th>N</th>
				<th>Fecha</th>
            ...
            <tbody>
				<?php
				    if($a2 == '-1'){
				       $block = mysqli_query($enlace, "SELECT * FROM 1800LoJusto WHERE fecha_registro BETWEEN '$fch1' AND '$fch2'"); 
				    }else{
				       $block = mysqli_query($enlace, "SELECT * FROM 1800LoJusto WHERE fecha_registro BETWEEN '$fch1' AND '$fch2' AND id_user='$a2'");
				    }
...
<script>
  ...
  $(function () {
    $('#example098').DataTable( {
        ...
        language: {
            "decimal":        "",
            "emptyTable":     "No hay registro de denuncias",
    ...
    function descargar_excel(){
       ...
       self.location = "2_1800lojusto/php/des_1800lojusto_xlsx.php?a19="+a1+"&a22="+a2+"&a33="+a3;
    }

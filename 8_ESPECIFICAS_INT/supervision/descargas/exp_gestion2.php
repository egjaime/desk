											...
											<div class="col-md-6">
												<div class="form-group" id="us2">
													...
													<option value="-1">Todos los asesores</option>
													    <?php
															$trx9="SELECT id, usuario FROM usuarios WHERE `servicio` like '%8%' ORDER BY `usuario` ASC";  
				  ...
				  $(function () {
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           $("#carga").load('8_ESPECIFICAS_INT/supervision/descargas/exp_val_exp_gestion2.php?a1='+camp1.value+'&a2='+camp2.value);

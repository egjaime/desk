...
?>
			...
			<body class="hold-transition skin-blue sidebar-mini">
				...
				<section class="content-header">
				  <h1>
					Bitácora llamadas entrantes - No alcance
				  </h1>
				  <ol class="breadcrumb">
					<li><a href="../menu.php"><i class="fa fa-dashboard"></i> Principal</a></li>
					<li><a>Usuario</a></li>
					<li class="active">Cierre ic-open</li>
				  </ol>
				</section>
											...
											<div class="col-md-6">
												<div class="form-group" id="us2">
													...
													<option value="-1">Todos los asesores</option>
													    <?php
															$trx9="SELECT id, usuario FROM usuarios WHERE `servicio` ORDER BY `usuario` ASC";  
				  ...
				  $(function () {
                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           $("#carga").load('8_ESPECIFICAS_INT/supervision/bitacora_entrante/exp_val_exp_gestion2.php?a1='+camp1.value+'&a2='+camp2.value);

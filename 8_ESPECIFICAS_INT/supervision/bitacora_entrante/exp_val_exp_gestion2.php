...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
  ...
  <link rel="stylesheet"
    ...
    <div class="modal-body"> 
      <table id="example293345193_223" class="table table-bordered table-striped">
        <thead>
            <tr>
                <th>Asesor</th>
                <th>Fecha</th>
            ...
            <tbody>
				<?php
				    if($a1==="-1"){
				      $block = mysqli_query($enlace, "SELECT *,CONCAT(u.1er_nombre,' ', u.1er_apellido) As nombre_as FROM INT_inter_bit e INNER JOIN usuarios u ON u.id=e.id_user WHERE e.fecha BETWEEN '$fch1' AND '$fch2'");
				    }else{
				        $block = mysqli_query($enlace, "SELECT *,CONCAT(u.1er_nombre,' ', u.1er_apellido) As nombre_as FROM INT_inter_bit e INNER JOIN usuarios u ON u.id=e.id_user WHERE id_user='$a1' AND e.fecha BETWEEN '$fch1' AND '$fch2'"); 
				    }
...
<script>
     ...
     function descargar_excel2(){
       ...
       self.location = "8_ESPECIFICAS_INT/supervision/bitacora_entrante/exp_dowload_excel2.php?a19="+a1+"&a22="+a2+"&a33="+a3;
    }
   
  $(function () {
    $('#example293345193_223').DataTable( {
        "destroy": true,
        "pageLength": 10,
        "searching": false,
        "lengthChange": false,

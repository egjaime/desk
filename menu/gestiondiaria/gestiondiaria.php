...
?>
			...
			<body class="hold-transition skin-blue sidebar-mini">
											...
											<div class="col-md-6">
												...
												<div id="id1" class="form-group">
													...
													<i class="fa fa-phone"></i>
													  ...
													  <input type="text" class="form-control" id="ani" data-mask tabindex="1" onBlur="pro_ani();" onKeyPress="return soloNumeros(event)" maxlength="10">
													</div>
													<div id="id1-1"></div>
												</div>
												...
												<div id="id4" class="form-group">
													...
													<i class="fa fa-list-alt"></i>
													  ...
													  <input type="text" class="form-control" id="cedula" onBlur="pro_ced();" onKeyPress="return soloNumeros(event)" maxlength="13" data-mask tabindex="12" >
													</div>
													<div id="id4-4"></div>
												</div>	
											...
											<div class="col-md-6">
												...
												<div id="id7" class="form-group">
													...
													<option selected="selected" value="" disabled>Seleccione..</option>
													  ...
													  <option value="3">Escalado N2</option>
													  <option value="4">Escalado VT</option>
													  <option value="5">Sin Audio - Caida</option>
												...
												<div id="SA2" style="display: none">
												     <div id="sa3" class="form-group">
    													...
    													<i class="fa fa-clock-o"></i>
    													  ...
    													  <input type="datetime" class="form-control" id="datehour2" onBlur="pro_sa3();" value="<?php echo date("H:i",time());?>" data-mask tabindex="8" >
    													</div>
    													<div id="sa03-03"></div>
    												</div>
    												...
    												<div id="sa4" class="form-group">
    													...
    													<option selected="selected" value="" disabled>Seleccione..</option>
    													  <option value="1">Desconexión Remota</option>
    													  <option value="2">Desconexión Local</option>
                                        ...
                                        <div class="box-body no-padding">
                                          <table class="table">
                                            ...
                                            <tr>
                                              <td></td>
                                              <td>Escalar N2</td>
                                              <td><span id="sn2" style="padding: 22px;"><i class="fa fa-refresh fa-spin"></i></span></td>
                                              <td></td>
                                              <td><span id="sn2P" class="badge bg-yellow">-</span></td>
                            				...
                            				<tr>
                                              ...
                                              <td></td>
                                              <td><span id="saudioP" class="badge bg-pink">-</span></td>
			    ...
			    function pro_refresh(){
			        ...
			        $('#sn2').hide().html('<i class="fa fa-refresh fa-spin">').fadeIn(500);
			        ...
			        $.ajax({
						type: 'POST',
						url: 'php/user/gestiondiaria/val_refresh.php', 
						data:  dataString, 
						success: function(x){
							...
							document.getElementById("sn2").innerHTML = x.split('_')[4];
							
								if(x.split('_')[4] != 0){
						            var sn2T = x.split('_')[4] * 100 / x.split('_')[0];
    						    	sn2T = sn2T.toFixed(1);
						            document.getElementById("sn2P").innerHTML = sn2T + "%";
						        }else{
						            if (x.split('_')[0] == 0){
						               document.getElementById("sn2P").innerHTML = "-";
						            }else{
						               document.getElementById("sn2P").innerHTML = "0.0%";
						            }
						        }


							document.getElementById("svt").innerHTML = x.split('_')[5];
							
								if(x.split('_')[5] != 0){
						            var sntT = x.split('_')[5] * 100 / x.split('_')[0];
    						    	sntT = sntT.toFixed(1);
        				        ...
        				        //valido si el estado es igual a Resuelto, Escalado N2, Escalado VT, Sin Audio Caida.
        				           ...
        				           $.ajax({
                    					...
                    					success: function(x){
                                            if(x == "1"){
                                               c3.className = "form-group has-error";
                        					   $('#id3-3').hide().html('<span class="help-block"><i class="fa fa-bell-o"></i> N° Ticket Repetido</span>').fadeIn(500);
                        					   e = 1;
                                            }else{
                                               c3.className = "form-group has-feedback";
                                        	   $('#id3-3').hide().html('').fadeIn(500);
				...
				function addcase(){
                    ...
                    if (camp7.value === '4'){
                      if (a === 0 && b === 0 && c === 0 && d === 0 && e === 0 && f === 0 && g === 0 && a1 === 0 && b1 === 0 && c1 === 0 && d1 === 0  && e1 === 0){
                            var dataString = 'a1=' + camp1.value + '&a2=' + camp2.value + '&a3=' + camp3.value + '&a4=' + camp4.value + '&a5=' + amd + '&a6=' + hour + '&a7=' + camp7.value + '&a8=' + camp8.value + '&a11=' + camp12.value + '&a21=' + camp22.value + '&a31=' + camp32.value + '&a41=' + camp42.value + '&a51=' + camp52.value + '&a99=' + check1;
                            xx = 2;
                            y = 1;
                      }
                    }else if(camp7.value === '5'){
 
                      if (a === 0 && b === 0 && c === 0 && d === 0 && e === 0 && f === 0 && g === 0 && a2 === 0 && b2 === 0 && c2 === 0 && d2 === 0){
                            var dataString = 'a1=' + camp1.value + '&a2=' + camp2.value + '&a3=' + camp3.value + '&a4=' + camp4.value + '&a5=' + amd + '&a6=' + hour + '&a7=' + camp7.value + '&a8=' + camp8.value + '&a11=' + camp13.value + '&a21=' + camp23.value + '&a31=' + camp33.value + '&a41=' + camp43.value + '&a99=' + check1;
                            xx = 3;
                            y = 1;
                      }
                    }else{
                       if (a === 0 && b === 0 && c === 0 && d === 0 && e === 0 && f === 0 && g === 0){
                            var dataString = 'a1=' + camp1.value + '&a2=' + camp2.value + '&a3=' + camp3.value + '&a4=' + camp4.value + '&a5=' + amd + '&a6=' + hour + '&a7=' + camp7.value + '&a8=' + camp8.value + '&a99=' + check1;
                            xx = 1;
                            y = 1; 
                       }
                    ...
                    if(y === 1){
                        ...
                        if (confirm("\xbfContinuar y guardar?")){
                            ...
                            var dataString = dataString + '&a40=' + res_TP;
    						...
    						if (xx === 1){
    							$.ajax({
    								type: 'POST',
    								url: 'php/user/gestiondiaria/val_addges.php', 
    								data:  dataString, 
    								success: function(x){
    									if(x==1){
    										$('#MsjError').hide().html('<div class="alert alert-success alert-dismissible"><button type="button" class="close" onclick="closeError()"  aria-hidden="true">&times;</button><strong>Guardado!</strong> Gestión guardada.<a href="#" class="alert-link"></a>.</div>').fadeIn(500);
                    						...
                    						save.disabled = false;
                					        $('#id3-3').hide().html('<span class="help-block"><i class="fa fa-bell-o"></i> N° Ticket Repetido</span>').fadeIn(500);
    										$('#MsjError').hide().html('<div class="alert alert-danger alert-dismissible"><button type="button" class="close" onclick="closeError()"  aria-hidden="true">&times;</button><strong>Msg Server:</strong> Ticket Omnicanal ya existe.<a href="#" class="alert-link"></a>.</div>').fadeIn(500);
    									}
    									else if(x==7){
    									    ...
    									    cancel.disabled = false;
                    						save.disabled = false;
                					        $('#MsjError').hide().html('<div class="alert alert-danger alert-dismissible"><button type="button" class="close" onclick="closeError()"  aria-hidden="true">&times;</button><strong>Msg Server:</strong> Error inesperado. Contacte al Administrador.<a href="#" class="alert-link"></a>.</div>').fadeIn(500);
    									    alert("Msg Error: " + x);
    									}
    								}
    							});
                                ...
                                $.ajax({
    								type: 'POST',
    								url: 'php/user/gestiondiaria/val_addgesVT.php', 
    								data:  dataString, 
    								success: function(x){
    									if(x==1){
    										$('#MsjError').hide().html('<div class="alert alert-success alert-dismissible"><button type="button" class="close" onclick="closeError()"  aria-hidden="true">&times;</button><strong>Guardado!</strong> Gestión guardada.<a href="#" class="alert-link"></a>.</div>').fadeIn(500);
                                ...
                                $.ajax({
    								type: 'POST',
    								url: 'php/user/gestiondiaria/val_addgesSA.php', 
    								data:  dataString, 
    								success: function(x){
    									if(x==1){
    										$('#MsjError').hide().html('<div class="alert alert-success alert-dismissible"><button type="button" class="close" onclick="closeError()"  aria-hidden="true">&times;</button><strong>Guardado!</strong> Gestión guardada.<a href="#" class="alert-link"></a>.</div>').fadeIn(500);

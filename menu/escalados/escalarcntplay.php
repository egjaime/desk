...
?>
			...
			<head>
			  ...
			  <title>Formularios - Escalar CNT PLay</title>
			...
			<body class="hold-transition skin-blue sidebar-mini">
									...
									<div class="box-body">
										...
										<div class="row">
											...
											<div class="col-md-6">
												...
												<div id="id2" class="form-group">
                							        <label for="exampleInputEmail1">*Correo Eléctronico CNT Play:</label>
                							        <div class="input-group">
                    							        <div class="input-group-addon">
        													<i class="fa fa-envelope-o"></i>
        												</div>
                							            <input type="email" class="form-control" id="email" onBlur="pro_mail(email.value);" placeholder="correo@impulsasc.com" data-mask tabindex="3">
                						             </div>	
                						             <div id="id2-2"></div>
            						             </div>
											...
											<div class="col-md-6">
												...
												<div id="id4" class="form-group">
													...
													<i class="fa fa-user"></i>
													  ...
													  <input type="text" class="form-control" id="nom" onBlur="pro_nom();" onKeyPress="return soloLetras(event)" maxlength="50" data-mask tabindex="2" >
													</div>
													<div id="id4-4"></div>
												</div>
                                                ...
                                                <div id="id5" class="form-group">
													<label>*Falla:</label>
													<select id="rol" class="form-control select2" style="width: 100%;" data-mask tabindex="4" onchange="pro_falla();" onBlur="pro_falla();">
													<option selected="selected" value="" disabled>Seleccione..</option>
													  <option value="1">Falla con usuario</option>
													  <option value="2">Falla con contraseña</option>
													  <option value="3">Falla con página</option>
													</select>
													<div id="id5-5"></div>
												</div>
                                       	...
                                       	<div id="id7" class="form-group">
											 ...
											 <textarea class="form-control" rows="2" id="dir" placeholder="..." style="resize: none; " data-mask tabindex="8" maxlength="245"></textarea>
										     <div id="id7-7"></div>
										</div>
										<div id="o_id1">	
										...
										<div class="row">
											...
											<table class="table text-center">
												<tr>
													<td width="49%">
														<button type="button" id="cancel" data-mask tabindex="10" onClick="clean();" class="btn btn-info pull-right">Cancelar</button>
													</td>
													<td width="2%">	
													</td>
													<td width="49%">
														<button type="button" data-mask tabindex="9" id="save" onClick="addcase();" class="btn btn-info pull-left" >Guardar</button>
													 </td>
												</tr>
											</table>
								</div>
				...
				<script>
    			    ...
    			    var camp2 = document.getElementById("email");
    			    var camp3 = document.getElementById("telf1");
    			    var camp4 = document.getElementById("nom");
    			    var camp5 = document.getElementById("rol");
                    ...
                    function pro_ced(){
    					if(camp1.value === ""){
    				       ...
    				       c1.className = "form-group has-error";
    				       $('#id1-1').hide().html('<span class="help-block"><i class="fa fa-bell-o"></i> Cédula / RUC incompleto</span>').fadeIn(500);
    					   a = 1;
    					}else{
				    ...
				    function pro_telf1(){
    					...
    					if(camp3.value === ""){
    				       ...
    				       c3.className = "form-group has-error";
    				       $('#id3-3').hide().html('<span class="help-block"><i class="fa fa-bell-o"></i> Teléfono incompleto</span>').fadeIn(500);
    					   c = 1;
    					}else{
    				...
    				function pro_mail(valor){
    					if(camp2.value === ""){
    					   ...
    					   f = 1;
                        	...
                        	if(!re.exec(valor)){
                        	   c2.className = "form-group has-error";
        					   $('#id2-2').hide().html('<span class="help-block"><i class="fa fa-bell-o"></i> Formato incorrecto</span>').fadeIn(500);
        					   f = 1;
                        	}else{
				    ...
				    function addcase(){
                        ...
                        if (a === 0 && b === 0 && c === 0 && e === 0 && f === 0){
                            if (confirm("\xbfContinuar y enviar?")){
    							...
    							$.ajax({
    								type: 'POST',
    								url: 'php/user/escalarcntplay/escalarcntplay.php', 
    								data:  dataString, 
    								success: function(x){
    									if(x==1){

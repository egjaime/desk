    							            ...
    							            <label for="exampleInputEmail1">*Correo Eléctronico:</label>
    							             <input type="email" class="form-control" id="email" placeholder="correo@impulsasc.com" tabindex="11">
												...
												<div class="form-group">
													 ...
													 <textarea class="form-control" rows="3" id="dir" placeholder="Ingrese dirección.." style="resize: none; " tabindex="11" maxlength="245"></textarea>
												</div>
											</div>
                                  ...
                                  <p class="help-block">* Campos Obligatorios.</p>
											...
											<table class="table text-center">
												<tr>
													...
													<td width="49%">
														<button type="button" id="save" onClick="modificar();" class="btn btn-info pull-left" >Modificar</button>
												  </td>
												</tr>
											</table>
										</div>
					...
					$.ajax({
						...
						success: function(x){
							...
							if(x==2){
								...
								document.getElementById('email').value = x.split('$$')[13];

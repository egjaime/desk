      ...
      <div class="row">
        ...
        <div class="col-lg-2 col-xs-5">
          ...
          <div class="small-box bg-teal">
            ...
            <a href="#" class="small-box-footer">Satisfacci&oacute;n</i></a>
          </div>
        </div>
        <!-- ./col -->
...
<script>
  ...
  function cuadros(){
        $.ajax({
            async: false,
          	type: 'POST',
          	url: 'php/dashboard/val_boards.php', 
          	success: function(x){
  ...
  function busquedaGraf(){
        $.ajax({
            async: false,
          	type: 'POST',
          	url: 'php/dashboard/val_Graf.php', 
          	success: function(x){
                if(x==1){
                    var1 = 0;
                    var2 = 0;
    ...
    function busquedaGraf2(){
        $.ajax({
            async: false,
          	type: 'POST',
          	url: 'php/dashboard/val_Graf2.php', 
          	success: function(p){
                if(p==1){
                         var6 = 0;
                         var7 = 0;
  ...
  function grafico(){
    var areaChartData = {
      labels  : ['Resuelto', 'Interaccion', 'Escalado N2', 'Escalado VT', 'Sin Audio'],
      datasets: [
        {
          label               : 'Mes anterior',
  ...
  //se inicia la carga de los div
    ...
    function busqueda(){
    	$.ajax({
    		type: 'POST',
    		url: 'php/dashboard/val_dash.php', 
    		success: function(x){
    		    if(x==1){
  ...
  function pro_cargaeyeall(){
	$("#eyeall1").load('php/dashboard/tmo_all.php'); 
  }
	
  function pro_cargaeyeone(){
	$("#eyeone1").load('php/dashboard/tmo_one.php'); 
  }

                    ...
                    function find(){
                        ...
                        if(a != 1 && b != 1 && c != 1){
                           ...
                           if(camp2.value === "5"){
                               ...
                               $("#carga").load('4_COLEGA/php/supervision/exp_val_exp_gestionGE.php?a1=1&a2='+camp1.value+'&a4='+b);
                           }else{
                               $("#carga").load('4_COLEGA/php/supervision/exp_val_exp_gestionGE.php?a1=2&a2='+camp1.value+'&a3='+camp2.value);
                           }

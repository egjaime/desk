        ...
        <head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
          ...
          <link rel="stylesheet"
            ...
            <div class="modal-body"> 
              <table id="examplecol" class="table table-bordered table-striped">
                <thead>
                     <tr>
                    ...
                    <tbody>
        				<?php
        				    $pos1 = 1;
        					$block = mysqli_query($enlace, "SELECT id_user, CONCAT(u.1er_nombre,' ', u.1er_apellido) As Nombre, COUNT(*) AS Total, SUM(g.tmo) as TMO, (SUM(g.tmo)/COUNT(*)) as Pos  FROM gestion_colega g INNER JOIN usuarios u ON u.id=g.id_user WHERE g.fecha BETWEEN '$fch1' AND '$fch2' AND g.id_user={$_SESSION['id']} GROUP BY g.id_user HAVING COUNT(*) >= 1 ORDER BY Pos ASC");

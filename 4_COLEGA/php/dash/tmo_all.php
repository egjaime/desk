        ...
        <head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
          ...
          <link rel="stylesheet"
            ...
            <div class="modal-body"> 
              <table id="examplecol2" class="table table-bordered table-striped">
                <thead>
                     <tr>
                    ...
                    <tbody>
        				<?php
        				    $pos1 = 1;
        					$block = mysqli_query($enlace, "SELECT CONCAT('assets/dist/img/',u.ci,'.png') As ruta2, CONCAT(u.1er_nombre,' ', u.1er_apellido) As Nombre, COUNT(*) AS Total, SUM(g.tmo) as TMO, (SUM(g.tmo)/COUNT(*)) as Pos  FROM gestion_colega g INNER JOIN usuarios u ON u.id=g.id_user WHERE g.fecha BETWEEN '$fch1' AND '$fch2' GROUP BY g.id_user HAVING COUNT(*) >= 1 ORDER BY Pos ASC");
        				...
        				?>
        					<tr>
        						...
        						<?php 
                                    ...
                                    if($rows['Pos'] > '285' && $rows['Pos'] < '299'){
                                ?>
        				            <td style="color:green;">    <?php echo $tmoT;?> &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-thumbs-o-up"></i> </td> <?php }else{   ?>
        						    <td style="color:red;">  <?php echo $tmoT;?> &nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-thumbs-o-down"></i> </td> <?php }?>
